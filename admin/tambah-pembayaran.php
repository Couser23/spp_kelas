...
$sudah_bayar = intval($data['nominal']) / 12;
$kekurangan = intval($data['nominal']) - intval($data_pembayaran2['jumlah_bayar']);
...
<form method="post" action="?url=proses-tambah-pembayaran&nisn=<?= $nisn; ?>" autocomplete="off">
    ...
    <div class="form-group mb-2">
        ...
        <input readonly type="number" name="jumlah_bayar" value="<?= $sudah_bayar ?>" class="form-control" min="0" required>
    </div>
    <label>Metode</label>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="../Ai Hoshino.jpg" alt="gambar" width="465" height="450">
                </div>
                <div class="modal-body">
    ...
    <div class="modal fade" id="bank" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <!-- Body Bank -->
                <div class="modal-body">
                    <p>BCA: 7866678760 - Kipe</p>
                    <p>Mandiri: 7877889776</p>
                    <p>BRI: 67845656120</p>
                    <p>BNI: 5454123122</p>
                </div>
                <!-- Footer Bank -->
