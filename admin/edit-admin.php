...
<hr>
<form method="post" action="?url=proses-edit-admin&id_petugas=<?= $id_petugas; ?>" autocomplete="off">
    ...
    <div class="form-group mb-2">
        <label>Level</label>
        <input value="admin" type="text" name="level" class="form-control" required>
    </div>
