...
<hr>
<form method="post" action="?url=proses-edit-siswa&nisn=<?= $nisn; ?>" autocomplete="off">
    ...
    <div class="form-group mb-2">
        ...
        <input value="<?= $data['no_telp'] ?>" type="tel" name="no_telp" class="form-control" pattern="^(?:\62|08)[1-9][0-9]{7,11}$" oninvalid="this.setCustomValidity('Gunakan kode 62 / 08')" oninput="setCustomValidity('')"/>
    </div>
    <div class="form-group mb-2">
        <label>No Ortu</label>
        <input value="<?= $data['no_ortu'] ?>" type="tel" name="no_ortu" class="form-control" pattern="^(?:\62|08)[1-9][0-9]{7,11}$" oninvalid="this.setCustomValidity('Gunakan kode 62 / 08')" oninput="setCustomValidity('')"/>
    </div>
    <div class="form-group mb-2">
        <label>Password</label>
        <input type="text" name="password" value="<?= $data['password'] ?>" placeholder="Password Untuk Akun Siswa" class="form-control" required>
    </div>
    <div class="form-group mb-2">
        <label>SPP</label>
