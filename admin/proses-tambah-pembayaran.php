...
if($hasil === 0) {
$sql = "INSERT INTO pembayaran(id_petugas,nisn,kelas,tgl_bayar,bulan_dibayar,tahun_dibayar,id_spp,jumlah_bayar,metode) VALUES('$id_petugas','$nisn','$kelas','$tgl_bayar','$bulan_bayar','$tahun_dibayar','$id_spp','$jumlah_bayar','$metode','$stst','$upload')";
