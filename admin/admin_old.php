...
<div class="container mt-5">
	...
	<div class="alert alert-info">
		Login Sebagai <b>Administrator</b> Aplikasi Pembayaran SPP
	</div>
	...
	<div class="card mt-2">
		<div class="card-body">
			...
			if(empty($file)){
				...
				echo"SPP merupakan iuran rutin sekolah yang mana pembayarannya dilakukan setiap sebulan sekali. SPP merupakan salah satu bentuk kewajiban setiap siswa yang masih aktif disekolah tersebut.";
			}else{
				include $file.'.php';
			}
			?>
