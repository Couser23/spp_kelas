...
<body>
 ...
 <div class="container">
    <div class="box">
    <form action="proses-login-petugas.php" method="post" autocomplete="off">
        <!------------------ Login Box --------------------->
        <div class="box-login" id="login">
            <div class="top-header">
                <h3>Hello, Admin/Petugas</h3>
                <small>Selamat Datang Di Pembayaran SPP.</small>
            </div>
            <div class="input-group">
                <div class="input-field">
                <input type="username" class="input-box" id="" name="username" required>
