...
<?php
    ...
    $no = 1;
    $STST = "Lunas";
    $sql = "SELECT*FROM pembayaran,siswa,kelas,spp,petugas WHERE pembayaran.nisn=siswa.nisn AND siswa.id_kelas=kelas.id_kelas AND pembayaran.id_spp=spp.id_spp AND pembayaran.id_petugas=petugas.id_petugas AND pembayaran.id_pembayaran='$nisn' AND pembayaran.Status='$STST' ORDER BY tgl_bayar DESC";
