  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../images/keqing.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="petugas.php?url=pembayaran" class="nav-link">
          ...
          <li class="nav-item">
              <a href="petugas.php?url=laporan" class="nav-link">
          ...
          <li class="nav-item">
              <a href="petugas.php?url=laporancari" class="nav-link">
          ...
          <li class="nav-item">
              <a href="petugas.php?url=verifikasi" class="nav-link">
      ...
      <div class="container-fluid">
        ...
        <div class="card mt-2">
          <div class="card-body">
            ...
            $file = @$_GET['url'];
            if (empty($file)) {
              echo "<h1>Selamat Datang Di Halaman Petugas, " . $_SESSION['nama_petugas'] . "</h1>";
